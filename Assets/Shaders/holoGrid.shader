  ...
  SubShader {
    ...
    Pass {
      ...
      VertexOut vert(VertexIn v) {
        ...
        o.ro = v.position;
        o.rd = mul( _World2Object , float4( -normalize(_WorldSpaceCameraPos - mPos ) , 0. )); 

       	o.camPos = mul( _World2Object , float4( _WorldSpaceCameraPos , 1. )).xyz;
        o.lightPos = mul( _World2Object , float4( 2. , 2. , -2. , 1. )).xyz ;
        return o;
