    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += mul( _Object2World, float4((node_7030+float3(node_9815,((node_2718*sin((((_node_5360*node_2718)+_node_973)*abs((mul( _World2Object, float4((mul(_Object2World, v.vertex).rgb-objPos.rgb),0) ).xyz.rgb.r*2.2)))))*1.0),node_9815)),0) ).xyz.rgb;
